...
{
    template<class Tipo>
    class Lista_LSE : public Interface_Lista<Tipo>
    {
    private:
        int quantidadeDeNos;
    ...
    void Lista_LSE<Tipo>::incluirInicio(Tipo informacao)
    {
        try
        {
            No_Simples<Tipo> *novoInicio = new No_Simples<Tipo>(informacao,0);                      // Crio um novo No com a informação
    ...
    void Lista_LSE<Tipo>::incluirNaPosicao(Tipo informacao,int posicao)
    {
        try
        {
            ...
            {
                No_Simples<Tipo> *novaPosicao = new No_Simples<Tipo>(informacao,0);                 // Crio um novo No com a informação
    ...
    int Lista_LSE<Tipo>::removerInformacao(Tipo informacao)
    {
        ...
        try
        {
            ...
            No_Simples<Tipo> *correrLista = this->inicio;                                           //Corre a lista do inicio
            while(correrLista->getProximoElemento()!=0)                                             //Enquanto não chegar no fim
            {
                ...
                {
                    No_Simples<Tipo> *paraDeletar = correrLista->getProximoElemento();              //Salve o endereco para deletar
