...
public:
    ...
    QListWidget *listWidget_MostrarLista;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(398, 601);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        layoutWidget = new QWidget(centralWidget);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 20, 351, 31));
        ...
        listWidget_MostrarLista = new QListWidget(centralWidget);
        listWidget_MostrarLista->setObjectName(QStringLiteral("listWidget_MostrarLista"));
        listWidget_MostrarLista->setGeometry(QRect(20, 60, 351, 481));
