...
namespace ED1
{
    ...
    public:
        Lista_LSE_Circular();
        ~Lista_LSE_Circular(){while(this->quantidadeDeNos!=0) this->removerInicio();}
    ...
    void Lista_LSE_Circular<Tipo>::incluirInicio(Tipo informacao)
    {
        try
        {
            No<Tipo> *novoInicio = new No<Tipo>(informacao,this->inicio);                       //Crie o No
    ...
    void Lista_LSE_Circular<Tipo>::incluirFinal(Tipo informacao)
    {
        try
        {
            ...
            {
                No<Tipo> *novoFinal = new No<Tipo>(informacao,this->inicio);                    //Cria o novo No final
    ...
    int Lista_LSE_Circular<Tipo>::removerInformacao(Tipo informacao)
    {
        ...
        try
        {
            ...
            No<Tipo> *correrLista = this->inicio;                                               //Comece a verificar do inicio
            ...
            for(int contador = 1 ; contador <= quantidade_Nos ; contador++)                     //Verifique todas as posicoes
            {
                ...
                {
                    No<Tipo> *paraDeletar = correrLista->getProximoElemento();                  //Salve o endereco do Nó
