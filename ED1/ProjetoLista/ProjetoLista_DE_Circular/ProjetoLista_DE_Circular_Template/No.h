...
namespace ED1
{
    ...
    public:
        ...
        No(const No& copia): informacao(copia.informacao),anterior(copia.anterior),proximo(copia.anterior){}
        No& operator=(const No& copia){informacao=copia.informacao; anterior=copia.anterior; proximo=anterior->proximo;}
