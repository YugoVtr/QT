...
void MainWindow::escolherOrdem(QString ordem)
{
    ...
    {
        const int inicio = 0;
        const int fim = lista_Pronta->size();
        if(ordem=="NOME")
        {
            TP2::OrdenarPorNome carregar_Arquivo(lista_Pronta,inicio,fim);                                                 //Cria a persistencia com o nome
            lista_Pronta = carregar_Arquivo.obterDadosOrdenado();                                               //Cria a lista para receber os dados
        }
        if(ordem=="CODIGO")
        {
            TP2::OrdenarPorCodigo carregar_Arquivo(lista_Pronta,inicio,fim);                                               //Cria a persistencia com o nome
            lista_Pronta = carregar_Arquivo.obterDadosOrdenado();                                               //Cria a lista para receber os dados
        }
        if(ordem=="EQUIPE e NOME")
        {
            TP2::OrdenarPorEquipe_Nome carregar_Arquivo(lista_Pronta,inicio,fim);                                          //Cria a persistencia com o nome
            lista_Pronta = carregar_Arquivo.obterDadosOrdenado();                                               //Cria a lista para receber os dados
        }
        if(ordem=="PAIS e NOME")
        {
            TP2::OrdenarPorPais_Nome carregar_Arquivo(lista_Pronta,inicio,fim);                                            //Cria a persistencia com o nome
            lista_Pronta = carregar_Arquivo.obterDadosOrdenado();                                               //Cria a lista para receber os dados
        }
        if(ordem=="MOTOR, EQUIPE e NOME")
        {
            TP2::OrdenarPorMotor_Equipe_Nome carregar_Arquivo(lista_Pronta,inicio,fim);                                    //Cria a persistencia com o nome
            lista_Pronta = carregar_Arquivo.obterDadosOrdenado();                                               //Cria a lista para receber os dados
        }
        if(ordem=="PONTUAÇÃO")
        {
            TP2::OrdenarPorPontuacao_Idade carregar_Arquivo(lista_Pronta,inicio,fim);                                      //Cria a persistencia com o nome
            lista_Pronta = carregar_Arquivo.obterDadosOrdenado();                                               //Cria a lista para receber os dados
        }
