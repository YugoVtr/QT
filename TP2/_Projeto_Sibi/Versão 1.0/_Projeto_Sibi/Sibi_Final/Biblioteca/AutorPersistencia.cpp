...
namespace Mumu
{
QString AutorPersistencia::consultar(const int codigo) const
{
...
void AutorPersistencia::incluir(Autor &objeto) const
{
...
void AutorPersistencia::alterar(Autor &objeto) const
{
...
QList<Autor> *AutorPersistencia::listagem() const
{
