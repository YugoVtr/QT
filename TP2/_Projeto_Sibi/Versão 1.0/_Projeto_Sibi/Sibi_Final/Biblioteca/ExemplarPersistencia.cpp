#include "ExemplarPersistencia.h"

namespace Biblioteca
{

ExemplarPersistencia::ExemplarPersistencia(QString nomeDoArquivoNoDisco) :
    nomeDoArquivoNoDisco(nomeDoArquivoNoDisco)
{

}

void ExemplarPersistencia::incluir(Exemplar &objeto) const
{
    std::ofstream arq;
...
void ExemplarPersistencia::alterar(Exemplar &objeto) const
{
...
QList<Exemplar> *ExemplarPersistencia::listagem() const
{
...
QString ExemplarPersistencia::consultar(int codigo) const
{
    std::ifstream arquivo;
    arquivo.open(this->nomeDoArquivoNoDisco.toStdString().c_str());
    std::string linha;
