...
void Reserva::montarObjeto(QString &str)
{
   ...
   Vitor::Usuario_Persistencia persistirUsuario("../Arquivos/arquivoUsuario_Persistencia.txt");
   Biblioteca::ExemplarPersistencia persistirExemplar("../Arquivos/arquivoExemplarPersistencia.txt");
