    ...
    adm()
{
    ...
    Vitor::Usuario_Persistencia busca("../Arquivos/usuarios.txt");
...
{
    ListarUsuario *w = new ListarUsuario();
    w->show();
    this->hide();
}
...
void frmJanelaPrincipal::on_pushButton_OK_clicked()
{
    ...
    Biblioteca::ExemplarPersistencia busca2("../Arquivos/arquivoExemplar.txt");
