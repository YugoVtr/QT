...
namespace Mumu
{
class ArtigoAutorPersistencia : public Vitor::Crud<ArtigoAutor>
{
private:
    QString nomeDoArquivoNoDisco;
public:
    ArtigoAutorPersistencia( ){ }
    ~ArtigoAutorPersistencia( ){ }
    ...
    ArtigoAutorPersistencia(QString nomeDoArquivoNoDisco){this->nomeDoArquivoNoDisco = nomeDoArquivoNoDisco;}
