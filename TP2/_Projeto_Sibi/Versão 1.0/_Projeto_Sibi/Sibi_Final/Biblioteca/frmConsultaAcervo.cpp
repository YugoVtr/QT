...
{
    ui->setupUi(this);
    Biblioteca::LivroPersistencia livroPersistencia("../Arquivos/arquivoLivro.txt");
    Biblioteca::RevistaPersistencia revistaPersistencia("../Arquivos/arquivoRevista.txt");
    Mumu::ArtigoPersistencia artigoPersistencia("../Arquivos/arquivoArtigo.txt");
    Mumu::VideoPersistencia videoPersistencia("../Arquivos/arquivoVideo.txt");
    Mumu::AutorPersistencia autorPersistencia("../Arquivos/arquivoAutor.txt");
    Biblioteca::EditoraPersistencia editoraPersistencia("../Arquivos/arquivoEditora.txt");
}
