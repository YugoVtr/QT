...
MultaPersistencia::MultaPersistencia():
    nomeDoArquivoEmDisco("")
{

}

void Mumu::MultaPersistencia::incluir(Mumu::Multa &objeto) const
{
...
void MultaPersistencia::alterar(Multa &objeto) const
{
...
QString MultaPersistencia::consultar(int codigo) const
{
...
QList<Multa> *MultaPersistencia::listagem() const
{
...
QList<Multa> MultaPersistencia::listagemPorUsuario(long long cpf) const
{
