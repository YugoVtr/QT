...
namespace Mumu
{
  ...
  void VideoPersistencia::incluir(Video &objeto) const
  {
  ...
  void VideoPersistencia::alterar(Video &objeto) const
  {
  ...
  void VideoPersistencia::alterar(int codigo, int ano, int tempo, QString titulo, QString genero, QString produtora)
  {
    Video x(codigo,ano,tempo,titulo,genero,produtora);
    alterar(x);
  }

  QString VideoPersistencia::consultar(const int codigo) const
  {
  ...
  QList<Video> *VideoPersistencia::listagem() const
  {
