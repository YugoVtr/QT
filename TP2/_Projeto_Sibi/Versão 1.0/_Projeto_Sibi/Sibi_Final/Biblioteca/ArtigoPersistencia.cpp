...
void ArtigoPersistencia::incluir(Artigo &objeto) const
{
...
void ArtigoPersistencia::alterar(Artigo &objeto) const
{
...
QString ArtigoPersistencia::consultar(const int codigo) const
{
...
QList<Artigo> *ArtigoPersistencia::listagem() const
{
