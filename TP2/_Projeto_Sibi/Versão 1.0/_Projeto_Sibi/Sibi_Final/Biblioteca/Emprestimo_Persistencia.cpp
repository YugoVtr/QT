#include "Emprestimo_Persistencia.h"

namespace Vitor
{
    void Emprestimo_Persistencia::incluir(Emprestimo &objeto) const
    {
        try
        {
    ...
    void Emprestimo_Persistencia::alterar(Emprestimo &objeto) const
    {
    ...
    void Emprestimo_Persistencia::carregarDados()
    {
        try
        {
    ...
    QList<Emprestimo> Emprestimo_Persistencia::buscarDados(long long cpf) const
    {
        try
        {
            std::ifstream arquivo;
    ...
    Emprestimo Emprestimo_Persistencia::consultar(long long cpf) const
    {
        for(int contador=0;contador<dados->size();contador++)
        {
    ...
    Emprestimo Emprestimo_Persistencia::consultar(int codigo) const
    {
        for(int contador=0;contador<dados->size();contador++)
        {
