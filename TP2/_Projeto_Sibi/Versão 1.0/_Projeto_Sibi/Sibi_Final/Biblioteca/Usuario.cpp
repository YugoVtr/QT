...
namespace Vitor
{
    ...
    void Usuario::montarObjeto(QString &str)
    {
        ...
        try
        {
            ...
            Telefone_Persistencia buscar_fone("../Arquivos/telefones.txt");
            telefone = buscar_fone.buscarDados(cpf);
            Endereco_Persistencia buscar_end("../Arquivos/enderecos.txt");
    ...
    {
        Biblioteca::ExemplarPersistencia mudar("../Arquivos/arquivoExemplar.txt");
        ...
        Emprestimo_Persistencia colocar("../Arquivos/emprestimos.txt");
        colocar.incluir(emp);
    }

    void Usuario::realizarDevolucao(Biblioteca::Exemplar &item)
    {
        Vitor::Emprestimo_Persistencia busca("../Arquivos/emprestimos.txt");
    ...
    void Usuario::gerarMulta(long long cpf, float valor)
    {
        ...
        Mumu::MultaPersistencia incluir;
