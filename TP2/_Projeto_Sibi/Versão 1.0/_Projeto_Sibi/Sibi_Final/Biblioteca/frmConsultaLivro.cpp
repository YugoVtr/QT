...
void frmConsultaLivro::on_tableWidget_cellClicked(int row, int column)
{
    try{
        ...
        Biblioteca::LivroAutorPersistencia livroAutorpersistencia("../Arquivos/arquivoLinkLivroAutor.txt");
        Biblioteca::LivroEditoraPersistencia livroEditoraPersistencia("../Arquivos/arquivoLinkLivroEditora.txt");

        QList<Biblioteca::LivroAutor> *listaAutor = livroAutorpersistencia.listagem(cod);
        Mumu::AutorPersistencia persistenciaAutor("../Arquivos/arquivoAutor.txt");
