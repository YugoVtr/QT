...
void MainWindow::on_pushButton_Criar_Matriz_1_clicked()
{
    try
    {
        ...
        ui->label_Exibir_Matriz_1->setText(matriz_1->getMatriz());//Exibir a matriz criada na tela
        ui->label_Exibir_Matriz_1->adjustSize();//Ajustar a janela ao tamanho da matriz
...
void MainWindow::on_pushButton_Limpar_Matriz_1_clicked()
{
    delete matriz_1;
    matriz_1 = 0;
    ui->label_Exibir_Matriz_1->clear();
...
void MainWindow::on_pushButton_Criar_Matriz_2_clicked()
{
    try
    {
        ...
        ui->label_Exibir_Matriz_2->setText(matriz_2->getMatriz());
        ui->label_Exibir_Matriz_2->adjustSize();
...
void MainWindow::on_pushButton_Limpar_Matriz_2_clicked()
{
    delete matriz_2;
    matriz_2 = 0;
    ui->label_Exibir_Matriz_2->clear();
