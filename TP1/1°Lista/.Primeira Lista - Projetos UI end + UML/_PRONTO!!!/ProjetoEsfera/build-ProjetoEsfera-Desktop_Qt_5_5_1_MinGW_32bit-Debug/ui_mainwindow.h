...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "PROJETO CLASSE ESFERA", 0));
        label->setText(QApplication::translate("MainWindow", "RAIO: ", 0));
